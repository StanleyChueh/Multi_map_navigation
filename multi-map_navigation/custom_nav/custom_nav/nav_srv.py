...
class NavHandler(Node):
    def __init__(self):
        ...
        ################################# #It will use the config in "config" folder
    ...
    def id2id_callback(self, request, response):#refer to srv_client_test.py in custom_nav folder
        self.mapServer(request.a, request.b)
        self.get_logger().info('Incoming request\na: %d b: %d' % (request.a, request.b))
        if request.a == 1: #initial pose
    ...
    def setPose(self):#refer to srv_client_test.py in custom_nav folder
    ...
    def runNavigation(self, time_out=1000000.0):#refer to srv_client_test.py in custom_nav folder
        self.navigator.goToPose(self.goal_pose)
       

    def send_request(self):#refer to srv_client_test.py in custom_nav folder
    ...
    def pubInitialPose(self):#refer to srv_client_test.py in custom_nav folder
